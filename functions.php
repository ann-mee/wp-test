...
function wptheme_scripts() {
	wp_enqueue_style( 'wptheme-style', get_template_directory_uri() . '/assets/css/style.min.css', array(), _S_VERSION );
	wp_style_add_data( 'wptheme-style', 'rtl', 'replace' );

	wp_enqueue_script( 'wptheme-script', get_template_directory_uri() . '/assets/js/scripts-min.js', array(), _S_VERSION, true );
...
if( function_exists('acf_add_local_field_group') ){
	acf_add_local_field_group(array(
		'key' => 'group_5f50b4c89446f',
		'title' => 'Slider',
		'fields' => array(
			array(
				'key' => 'field_5f50b4d0211cb',
				'label' => 'Slides',
				'name' => 'slide',
				'type' => 'repeater',
				'instructions' => '',
